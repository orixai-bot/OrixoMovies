const initialMovies = [
    ...
    // A large block of placeholder movies to reach 900+
    { id: 751, title: "Movie 751", year: 2000, rating: 7.1, genre: "Action" },
    { id: 752, title: "Movie 752", year: 2001, rating: 7.2, genre: "Comedy" },
    { id: 753, title: "Movie 753", year: 2002, rating: 7.3, genre: "Drama" },
    { id: 754, title: "Movie 754", year: 2003, rating: 7.4, genre: "Thriller" },
    { id: 755, title: "Movie 755", year: 2004, rating: 7.5, genre: "Sci-Fi" },
    { id: 756, title: "Movie 756", year: 2005, rating: 7.6, genre: "Romance" },
    { id: 757, title: "Movie 757", year: 2006, rating: 7.7, genre: "Horror" },
    { id: 758, title: "Movie 758", year: 2007, rating: 7.8, genre: "Crime" },
    { id: 759, title: "Movie 759", year: 2008, rating: 7.9, genre: "Fantasy" },
    { id: 760, title: "Movie 760", year: 2009, rating: 8.0, genre: "Animation" },
    { id: 761, title: "Movie 761", year: 2010, rating: 8.1, genre: "Biography" },
    { id: 762, title: "Movie 762", year: 2011, rating: 8.2, genre: "Sports" },
    { id: 763, title: "Movie 763", year: 2012, rating: 8.3, genre: "War" },
    { id: 764, title: "Movie 764", year: 2013, rating: 8.4, genre: "Mystery" },
    { id: 765, title: "Movie 765", year: 2014, rating: 8.5, genre: "Adventure" },
    { id: 766, title: "Movie 766", year: 2015, rating: 8.6, genre: "Action" },
    { id: 767, title: "Movie 767", year: 2016, rating: 8.7, genre: "Comedy" },
    { id: 768, title: "Movie 768", year: 2017, rating: 8.8, genre: "Drama" },
    { id: 769, title: "Movie 769", year: 2018, rating: 8.9, genre: "Thriller" },
    { id: 770, title: "Movie 770", year: 2019, rating: 9.0, genre: "Sci-Fi" },
    { id: 771, title: "Movie 771", year: 2020, rating: 7.0, genre: "Romance" },
    { id: 772, title: "Movie 772", year: 2021, rating: 6.9, genre: "Horror" },
    { id: 773, title: "Movie 773", year: 2022, rating: 6.8, genre: "Crime" },
    { id: 774, title: "Movie 774", year: 2023, rating: 6.7, genre: "Fantasy" },
    { id: 775, title: "Movie 775", year: 2024, rating: 6.6, genre: "Animation" },
    { id: 776, title: "Movie 776", year: 2000, rating: 6.5, genre: "Biography" },
    { id: 777, title: "Movie 777", year: 2001, rating: 6.4, genre: "Sports" },
    { id: 778, title: "Movie 778", year: 2002, rating: 6.3, genre: "War" },
    { id: 779, title: "Movie 779", year: 2003, rating: 6.2, genre: "Mystery" },
    { id: 780, title: "Movie 780", year: 2004, rating: 6.1, genre: "Adventure" },
    { id: 781, title: "Movie 781", year: 2005, rating: 6.0, genre: "Action" },
    { id: 782, title: "Movie 782", year: 2006, rating: 5.9, genre: "Comedy" },
    { id: 783, title: "Movie 783", year: 2007, rating: 5.8, genre: "Drama" },
    { id: 784, title: "Movie 784", year: 2008, rating: 5.7, genre: "Thriller" },
    { id: 785, title: "Movie 785", year: 2009, rating: 5.6, genre: "Sci-Fi" },
    { id: 786, title: "Movie 786", year: 2010, rating: 5.5, genre: "Romance" },
    { id: 787, title: "Movie 787", year: 2011, rating: 5.4, genre: "Horror" },
    { id: 788, title: "Movie 788", year: 2012, rating: 5.3, genre: "Crime" },
    { id: 789, title: "Movie 789", year: 2013, rating: 5.2, genre: "Fantasy" },
    { id: 790, title: "Movie 790", year: 2014, rating: 5.1, genre: "Animation" },
    { id: 791, title: "Movie 791", year: 2015, rating: 5.0, genre: "Biography" },
    { id: 792, title: "Movie 792", year: 2016, rating: 4.9, genre: "Sports" },
    { id: 793, title: "Movie 793", year: 2017, rating: 4.8, genre: "War" },
    { id: 794, title: "Movie 794", year: 2018, rating: 4.7, genre: "Mystery" },
    { id: 795, title: "Movie 795", year: 2019, rating: 4.6, genre: "Adventure" },
    { id: 796, title: "Movie 796", year: 2020, rating: 4.5, genre: "Action" },
    { id: 797, title: "Movie 797", year: 2021, rating: 4.4, genre: "Comedy" },
    { id: 798, title: "Movie 798", year: 2022, rating: 4.3, genre: "Drama" },
    { id: 799, title: "Movie 799", year: 2023, rating: 4.2, genre: "Thriller" },
    { id: 800, title: "Movie 800", year: 2024, rating: 4.1, genre: "Sci-Fi" },
    { id: 801, title: "Movie 801", year: 2000, rating: 4.0, genre: "Romance" },
    { id: 802, title: "Movie 802", year: 2001, rating: 3.9, genre: "Horror" },
    { id: 803, title: "Movie 803", year: 2002, rating: 3.8, genre: "Crime" },
    { id: 804, title: "Movie 804", year: 2003, rating: 3.7, genre: "Fantasy" },
    { id: 805, title: "Movie 805", year: 2004, rating: 3.6, genre: "Animation" },
    { id: 806, title: "Movie 806", year: 2005, rating: 3.5, genre: "Biography" },
    { id: 807, title: "Movie 807", year: 2006, rating: 3.4, genre: "Sports" },
    { id: 808, title: "Movie 808", year: 2007, rating: 3.3, genre: "War" },
    { id: 809, title: "Movie 809", year: 2008, rating: 3.2, genre: "Mystery" },
    { id: 810, title: "Movie 810", year: 2009, rating: 3.1, genre: "Adventure" },
    { id: 811, title: "Movie 811", year: 2010, rating: 8.5, genre: "Action" },
    { id: 812, title: "Movie 812", year: 2011, rating: 7.9, genre: "Comedy" },
    { id: 813, title: "Movie 813", year: 2012, rating: 7.5, genre: "Drama" },
    { id: 814, title: "Movie 814", year: 2013, rating: 7.0, genre: "Thriller" },
    { id: 815, title: "Movie 815", year: 2014, rating: 6.5, genre: "Sci-Fi" },
    { id: 816, title: "Movie 816", year: 2015, rating: 6.0, genre: "Romance" },
    { id: 817, title: "Movie 817", year: 2016, rating: 8.8, genre: "Horror" },
    { id: 818, title: "Movie 818", year: 2017, rating: 8.0, genre: "Crime" },
    { id: 819, title: "Movie 819", year: 2018, rating: 7.6, genre: "Fantasy" },
    { id: 820, title: "Movie 820", year: 2019, rating: 7.1, genre: "Animation" },
    { id: 821, title: "Movie 821", year: 2020, rating: 6.6, genre: "Biography" },
    { id: 822, title: "Movie 822", year: 2021, rating: 6.1, genre: "Sports" },
    { id: 823, title: "Movie 823", year: 2022, rating: 8.9, genre: "War" },
    { id: 824, title: "Movie 824", year: 2023, rating: 8.2, genre: "Mystery" },
    { id: 825, title: "Movie 825", year: 2024, rating: 7.7, genre: "Adventure" },
    { id: 826, title: "Movie 826", year: 2000, rating: 7.2, genre: "Action" },
    { id: 827, title: "Movie 827", year: 2001, rating: 6.7, genre: "Comedy" },
    { id: 828, title: "Movie 828", year: 2002, rating: 6.2, genre: "Drama" },
    { id: 829, title: "Movie 829", year: 2003, rating: 9.1, genre: "Thriller" },
    { id: 830, title: "Movie 830", year: 2004, rating: 8.5, genre: "Sci-Fi" },
    { id: 831, title: "Movie 831", year: 2005, rating: 8.0, genre: "Romance" },
    { id: 832, title: "Movie 832", year: 2006, rating: 7.5, genre: "Horror" },
    { id: 833, title: "Movie 833", year: 2007, rating: 7.0, genre: "Crime" },
    { id: 834, title: "Movie 834", year: 2008, rating: 6.5, genre: "Fantasy" },
    { id: 835, title: "Movie 835", year: 2009, rating: 6.0, genre: "Animation" },
    { id: 836, title: "Movie 836", year: 2010, rating: 5.5, genre: "Biography" },
    { id: 837, title: "Movie 837", year: 2011, rating: 9.2, genre: "Sports" },
    { id: 838, title: "Movie 838", year: 2012, rating: 8.6, genre: "War" },
    { id: 839, title: "Movie 839", year: 2013, rating: 8.1, genre: "Mystery" },
    { id: 840, title: "Movie 840", year: 2014, rating: 7.6, genre: "Adventure" },
    { id: 841, title: "Movie 841", year: 2015, rating: 7.1, genre: "Action" },
    { id: 842, title: "Movie 842", year: 2016, rating: 6.6, genre: "Comedy" },
    { id: 843, title: "Movie 843", year: 2017, rating: 6.1, genre: "Drama" },
    { id: 844, title: "Movie 844", year: 2018, rating: 9.3, genre: "Thriller" },
    { id: 845, title: "Movie 845", year: 2019, rating: 8.7, genre: "Sci-Fi" },
    { id: 846, title: "Movie 846", year: 2020, rating: 8.2, genre: "Romance" },
    { id: 847, title: "Movie 847", year: 2021, rating: 7.7, genre: "Horror" },
    { id: 848, title: "Movie 848", year: 2022, rating: 7.2, genre: "Crime" },
    { id: 849, title: "Movie 849", year: 2023, rating: 6.7, genre: "Fantasy" },
    { id: 850, title: "Movie 850", year: 2024, rating: 6.2, genre: "Animation" },
    { id: 851, title: "Movie 851", year: 2000, rating: 5.7, genre: "Biography" },
    { id: 852, title: "Movie 852", year: 2001, rating: 9.4, genre: "Sports" },
    { id: 853, title: "Movie 853", year: 2002, rating: 8.8, genre: "War" },
    { id: 854, title: "Movie 854", year: 2003, rating: 8.3, genre: "Mystery" },
    { id: 855, title: "Movie 855", year: 2004, rating: 7.8, genre: "Adventure" },
    { id: 856, title: "Movie 856", year: 2005, rating: 7.3, genre: "Action" },
    { id: 857, title: "Movie 857", year: 2006, rating: 6.8, genre: "Comedy" },
    { id: 858, title: "Movie 858", year: 2007, rating: 6.3, genre: "Drama" },
    { id: 859, title: "Movie 859", year: 2008, rating: 9.5, genre: "Thriller" },
    { id: 860, title: "Movie 860", year: 2009, rating: 8.9, genre: "Sci-Fi" },
    { id: 861, title: "Movie 861", year: 2010, rating: 8.4, genre: "Romance" },
    { id: 862, title: "Movie 862", year: 2011, rating: 7.9, genre: "Horror" },
    { id: 863, title: "Movie 863", year: 2012, rating: 7.4, genre: "Crime" },
    { id: 864, title: "Movie 864", year: 2013, rating: 6.9, genre: "Fantasy" },
    { id: 865, title: "Movie 865", year: 2014, rating: 6.4, genre: "Animation" },
    { id: 866, title: "Movie 866", year: 2015, rating: 9.6, genre: "Biography" },
    { id: 867, title: "Movie 867", year: 2016, rating: 9.0, genre: "Sports" },
    { id: 868, title: "Movie 868", year: 2017, rating: 8.5, genre: "War" },
    { id: 869, title: "Movie 869", year: 2018, rating: 8.0, genre: "Mystery" },
    { id: 870, title: "Movie 870", year: 2019, rating: 7.5, genre: "Adventure" },
    { id: 871, title: "Movie 871", year: 2020, rating: 7.0, genre: "Action" },
    { id: 872, title: "Movie 872", year: 2021, rating: 6.5, genre: "Comedy" },
    { id: 873, title: "Movie 873", year: 2022, rating: 6.0, genre: "Drama" },
    { id: 874, title: "Movie 874", year: 2023, rating: 9.7, genre: "Thriller" },
    { id: 875, title: "Movie 875", year: 2024, rating: 9.1, genre: "Sci-Fi" },
    { id: 876, title: "Movie 876", year: 2000, rating: 8.6, genre: "Romance" },
    { id: 877, title: "Movie 877", year: 2001, rating: 8.1, genre: "Horror" },
    { id: 878, title: "Movie 878", year: 2002, rating: 7.6, genre: "Crime" },
    { id: 879, title: "Movie 879", year: 2003, rating: 7.1, genre: "Fantasy" },
    { id: 880, title: "Movie 880", year: 2004, rating: 6.6, genre: "Animation" },
    { id: 881, title: "Movie 881", year: 2005, rating: 9.8, genre: "Biography" },
    { id: 882, title: "Movie 882", year: 2006, rating: 9.2, genre: "Sports" },
    { id: 883, title: "Movie 883", year: 2007, rating: 8.7, genre: "War" },
    { id: 884, title: "Movie 884", year: 2008, rating: 8.2, genre: "Mystery" },
    { id: 885, title: "Movie 885", year: 2009, rating: 7.7, genre: "Adventure" },
    { id: 886, title: "Movie 886", year: 2010, rating: 7.2, genre: "Action" },
    { id: 887, title: "Movie 887", year: 2011, rating: 6.7, genre: "Comedy" },
    { id: 888, title: "Movie 888", year: 2012, rating: 9.9, genre: "Drama" },
    { id: 889, title: "Movie 889", year: 2013, rating: 9.3, genre: "Thriller" },
    { id: 890, title: "Movie 890", year: 2014, rating: 8.8, genre: "Sci-Fi" },
    { id: 891, title: "Movie 891", year: 2015, rating: 8.3, genre: "Romance" },
    { id: 892, title: "Movie 892", year: 2016, rating: 7.8, genre: "Horror" },
    { id: 893, title: "Movie 893", year: 2017, rating: 7.3, genre: "Crime" },
    { id: 894, title: "Movie 894", year: 2018, rating: 6.8, genre: "Fantasy" },
    { id: 895, title: "Movie 895", year: 2019, rating: 6.3, genre: "Animation" },
    { id: 896, title: "Movie 896", year: 2020, rating: 5.8, genre: "Biography" },
    { id: 897, title: "Movie 897", year: 2021, rating: 10.0, genre: "Sports" },
    { id: 898, title: "Movie 898", year: 2022, rating: 9.4, genre: "War" },
    { id: 899, title: "Movie 899", year: 2023, rating: 8.9, genre: "Mystery" },
    { id: 900, title: "Movie 900", year: 2024, rating: 8.4, genre: "Adventure" }
];
